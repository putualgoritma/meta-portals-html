          ...
          <ul class="treeview-menu">
            <li>
              <div class="panel-body">
               <label>The first question (in this example an open question) about the chosen main discipline.</label>
				<textarea class="form-control" rows="5">"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."</textarea>
                <hr>
               <label>The second question (in this example an open question) about the chosen main discipline.</label>
               <textarea class="form-control" rows="5">"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."</textarea> 
               <hr>
               <label>The third question (in this example an multiple choice question) about the chosen main discipline.</label>
               <div class="row">
               ...
               <label class="checkbox">
                ...
                <label>The fourth question (in this example an open question) about the chosen main discipline.</label>
                <select class="form-control select">
                ...
                <br>
                <hr>
                <label>The fifth question (in this example an multiple choice question) about the chosen main discipline.</label>
                <div class="row clearfix">
                ...
                <div class="clear">&nbsp;</div>
                <hr>
                <label>The sixth question (in this example an open question) about the chosen main discipline.</label>
                <input type="text" class="form-control" placeholder="Lorem Ipsum">
                <br>
                <hr>
                <label>The seventh question (in this example an open question) about the chosen main discipline.</label>
                ...
                <hr>
                <label>The eighth question (in this example an open question) about the chosen main discipline.</label>
				...
				<div class="clear">&nbsp;</div>
                <hr>
                <label>The ninth question (in this example an open question) about the chosen main discipline.</label>
                <div class="row body-box">
                <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
					From 
				</div>
				<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
					<input type="text" class="form-control" id="dp1" style="width:100%;"> 
				</div>
				<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
					To 
				</div>
				<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
					<input type="text" class="form-control" id="dp2"  style="width:100%;"> 
				</div>
                </div>
                <hr>
                <label>The tenth question (in this example an open question) about the chosen main discipline.</label>
                <input type="text" class="form-control" placeholder="Add by enter">
