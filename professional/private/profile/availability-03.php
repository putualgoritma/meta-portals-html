...
<?php include('../../../components/private/menus/left_menu_private.php'); ?>
            ...
            <label><strong>Desired fee per hour:</strong></label>
            <div class="row body-box">
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                    <input type="number" class="form-control bfh-number" value="10"/>
                </div>
		...
		<label><strong>Var valid until if applicable:</strong></label> <br>
			<input type="text" class="form-control">
		</div>

				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
		<label><strong>CoC number:</strong></label> <br>
        ...
        <div class="row body-box">
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
		<label><strong>VAT number:</strong></label> <br>
			<input type="text" class="form-control">
		</div>

				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
		<label><strong>Fiscal number:</strong></label> <br>
			<input type="text" class="form-control">
		</div>
        </div>
            <hr>
            
            <label><strong>Desired compensation per month based on 40 hours a week:</strong></label>
            <br>
            <div class="row body-box">
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                    <input type="number" class="form-control bfh-number" value="10"/>
            ...
            <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <input type="checkbox" name="answer" value="answer6">  Regular
            <br>
			<input type="checkbox" name="answer" value="answer1"> Evenings
            <br>
            ...
            <br>
            <input type="checkbox" name="answer" value="answer5">  Weekends
            <br>
            <input type="checkbox" name="answer" value="answer5"> Flexible
            <br>

            </div>
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <input type="checkbox" name="answer" value="answer3">  Fixed
            <br>
            <input type="checkbox" name="answer" value="answer4">  Irregular
            <br>
             <input type="checkbox" name="answer" value="answer5"> Shifts
             <br>
