...
<div class="wrapper row-offcanvas row-offcanvas-left">
  <?php include('../../../components/private/menus/left_menu_private.php'); ?>
		...
		<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
          ...
          <div>&nbsp;</div>
          <embed width="100%" height="315" src="http://www.youtube.com/embed/ttJI-liR78k" frameborder="0" allowfullscreen></embed>
			<div>&nbsp;</div>
            <p>Select a Resume or add a new one</p>            
            <div class="row body-box">
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
        	     <select class="form-control select">
                     ...
                     <button class="btn btn-danger">Edit resume</button>
                     </div>
       				 </div>
            <div>&nbsp;</div>         
...
rem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim.
...
<p>Select a Resume or add a new one</p>
		...
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
        <div class="btn-pull-right">
		<button class="btn btn-danger">Save as a new template</button>
        </div>
        </div>
        </div>          
        
        <div class="btn-pull-right"><button class="btn btn-danger">Submit</button></div> 
        <div class="clear">&nbsp;</div>
