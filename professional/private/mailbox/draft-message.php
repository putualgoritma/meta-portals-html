            ...
            <?php include('../../../components/private/menus/top_menu_private.php'); ?>
                ...
                <section class="content-header col-md-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Draft message</li>
                    </ol>
                </section>
               ...
               <div class="btn-pull-right">
                <button class="btn btn-info"><i class="fa fa-trash-o"></i> Continee write</button>
                <button class="btn btn-info"><i class="fa fa-undo"></i> Delete</button></div>
                <div class="clear">&nbsp;</div>
                <hr>
                <ul class="pagination pagination-sm no-margin pull-right">
                 ...
                 <div class="clear">&nbsp;</div>
                 <div class="btn-pull-right"><form action="../../../company/private/mailbox/trash.php" method="post"><button id="sent" class="btn btn-info"><i class="fa fa-undo"></i> Back to trash</button></form></div>                   
