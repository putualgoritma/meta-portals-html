...
<?php include('../../../components/private/menus/left_menu_private.php'); ?>
            ...
            <?php include('../../../components/private/menus/top_menu_private.php'); ?>
               ...
               <div class="btn-pull-right">
                <button class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete permenantly</button>
                <button class="btn btn-danger"><i class="fa fa-undo"></i> Restore</button></div>
                <div class="clear">&nbsp;</div>
                <hr>
                <ul class="pagination pagination-sm no-margin pull-right">
                 ...
                 <div class="clear">&nbsp;</div>
                 <div class="btn-pull-right"><form action="../../../company/private/mailbox/trash.php" method="post"><button id="sent" class="btn btn-danger"><i class="fa fa-undo"></i> Back to trash</button></form></div>                   
