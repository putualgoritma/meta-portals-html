...
<?php include('../../../components/private/menus/left_menu_private.php'); ?>
            ...
            <?php include('../../../components/private/menus/top_menu_private.php'); ?>
               ...
               <button class="btn btn-danger"><i class="fa fa-envelope"></i> Report message</button>
               <button class="btn btn-danger"><i class="fa fa-forward"></i> Forward</button>
                <button class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</button>
                <button class="btn btn-danger"><i class="fa fa-reply"></i> Reply</button></div>
                <div class="clear">&nbsp;</div>
                <hr>
                <ul class="pagination pagination-sm no-margin pull-right">
                 ...
                 <div class="clear">&nbsp;</div>
                 <div class="btn-pull-right"><form action="inbox.php" method="post"><button id="sent" class="btn btn-danger"><i class="fa fa-undo"></i> Back to inbox</button></form></div>                   
