...
<?php include('../../../components/private/menus/left_menu_private.php'); ?>
            ...
            <?php include('../../../components/private/menus/top_menu_private.php'); ?>
                ...
                <div class="btn-pull-left"><button type="submit" id="delete" class="btn btn-danger"><i class="fa fa-trash-o"></i> Remove All Tags</button></div>
                <div class="clear">&nbsp;</div>
                <div class="btn-pull-right">
                <button type="submit" id="delete" class="btn btn-danger"><i class="fa fa-plus"></i> Add to cart</button>
                <button type="submit" id="delete" class="btn btn-danger"><i class="fa fa-undo"></i> Back to product overview</button></div>
                <div class="clear">&nbsp;</div>
                </div>
                  </div>
