...
<?php include('../../../components/private/menus/left_menu_private.php'); ?>
            ...
            <?php include('../../../components/private/menus/top_menu_private.php'); ?>
                ...
                <h2>Thank you!</h2>
                <p>Thank you for your order, [insert name]! Your order details can be found in your order history
When [variable happens] you will be contacted as soon as possible.</p>
				
                <button type="submit" class="btn btn-danger">Back to product overview</button>
    			</div>
                  </div>
