...
<?php include('../../../components/private/menus/left_menu_private.php'); ?>
            ...
            <?php include('../../../components/private/menus/top_menu_private.php'); ?>
                ...
                <div class="box box-body">
                 <h3>Select a method of payment</h3>
                 <div>&nbsp;</div>
                 <div class="row">
		<div class="col-xs-1 col-sm-1 col-md-1 text-center" st>
				<label for="ideal"><img src="../../../img/iDeal.png" class="payment-icons" /> </label><br>
					<input class="paymethod" type="radio" name="paymethod" value="ideal" id="ideal"/>
		</div>
		...
		<div class="col-xs-2 col-sm-2 col-md-2 text-center">		
            ...
            <p>
            [First name] [Family name prefix] [Family name]<br>
			[Street] [Number] [Suffix]<br>
            [Postal code]<br>
            [City]<br>
            [Country]<br>
            </p>
                ...
                <hr>
                <div class="btn-pull-right"><button class="btn btn-info btn-sm">comfirm and play</button></div>
                 <div class="clear">&nbsp;</div>                   
                 </div>
