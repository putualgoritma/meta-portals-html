...
<div class="container">
                ...
                <div class="vid">
                <iframe width="700" height="400" src="//www.youtube.com/embed/ac7KhViaVqc" allowfullscreen=""></iframe>
                </div>
                <div>&nbsp;</div>
                
                <h2><i>"Lorem ipsum baffa bara baka bana" - fayaaz 2014</i></h2>
                
                <img width="100%" height="300px;" src="../../../img/blog5.jpg" class="img-responsive">
                
                <div>&nbsp;</div>
                
                <div class="pull-right"><a class="btn btn-block btn-social btn-twitter">
                ...
                <h4>Recent Professional ...</h4>
                <div class="row body-box">
				<div class="col-xs-6 col-sm-4 col-md-4">
				<img src="../../../img/avatar5.png" class="img-responsive">
				</div>
					
				<div class="col-xs-6 col-sm-8 col-md-8">
                <p><strong>Professional name</strong></p>
				
                <p><i class="fa fa-phone"></i> 06-893487<br>
                <i class="fa fa-envelope"></i> Info@peperkamp.nl</p>
                
                <a href="../../../professional/public/index.php">view more</a>				</div>
				</div>
                <br>

                <div class="row body-box">
				<div class="col-xs-6 col-sm-4 col-md-4">
				<img src="../../../img/avatar4.png" class="img-responsive">
				</div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <h4>Top 5 Professional ...</h4>
                <div class="row body-box">
				<div class="col-xs-6 col-sm-4 col-md-4">
				<img src="../../../img/avatar3.png" class="img-responsive">
				</div>
                ...
                <form action="subscribe.php" method="post"><div class="btn-pull-right"><button class="btn btn-info"><i class="fa fa-envelope"></i> Subscribe to newsletter</button></div></form>
