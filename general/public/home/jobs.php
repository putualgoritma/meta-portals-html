...
<div class="container">
                ...
                <div class="btn-pull-right"><form action="subscribe.php" method="post"><button class="btn btn-info"><i class="fa fa-envelope"></i> Subscribe to newsletter</button></form></div>
