...
<div class="container">
  ...
  <section class="content">
    ...
    <section class="content-header col-md-12">
                ...
                <li class="active">Forgot password confirmation</li>
                </ul>
                </div>
                    </div>
    ...
    <div class="row clearfix">
      <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="box panel-body box-danger">
          ...
          <p>An email has been sent to [email address] to reset your password. Please check your email account.</p>
                 
		  <a href="../changepassword/changepassword.php">[Test Link]</a>
          </p>
        </div>
      </div>
    </div>
