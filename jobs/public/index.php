...
<div class="container">
                ...
                <a href="profile/description.php">
                <div class="small-box2 bg-purple">
                <h3>Discipline <i class="fa fa-arrow-circle-right"></i></h3>
                <strong>blog of the day</strong>
                <div class="line-box">&nbsp;</div>
                <div>&nbsp;</div>
                <p>x new blogs today.
				<br>
				x new blogs of people you follow.</p>
