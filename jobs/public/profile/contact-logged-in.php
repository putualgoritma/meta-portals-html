...
<div class="container">
                ...
                <section class="content-header col-md-12">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     ...
                     <li><a href="../index.php">Jobs home</a></li>
                     <li class="active">Contact logged in</li>
                        </ul>
                                            </div>
                    </div>
                ...
                <div class="row">
                   ...
                   <select class="select form-control">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6" >
                    <label><strong>Choose a template(optional)</strong></label>
                   <select class="select form-control">
                       <option>current photo 2</option>
                       <option>Photo 3</option>
                    </select>
                   ...
                   <br>
                    ...
                    <div class="btn-pull-left"><button class="btn btn-info">Submit</button></div>
                    <div class="clear">&nbsp;</div>
                    ...
                    <div class="btn-pull-left"><button class="btn btn-info">Save Template</button></div>                
