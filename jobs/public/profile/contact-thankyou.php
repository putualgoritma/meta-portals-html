...
<div class="container">
                ...
                <section class="content-header col-md-12">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     ...
                     <li class="active">Contact thankyou</li>
                        </ul>
                                            </div>
                    </div>
                ...
                <h2 style="margin-top: 0px;">Thank you for contacting me</h2>
                <p>Dear...</br>
	Your appilication has been succesfully send. You can go back to <a href="">[professional page]</a> or <a href="">[profile page]</a></p>
                              </div>
