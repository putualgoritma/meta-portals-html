            ...
            <?php include('../../../components/private/menus/top_menu_private.php'); ?>
                ...
                <section class="content-header col-md-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Description preview</li>
                    </ol>
                </section>
          ...
          <ul class="treeview-menu">
            ...
            <select class="select form-control">
              ...
              <div class="row body-box">
                                                    ...
                                                    <label><strong>Suffix</strong></label> <br>
           ...
           <div class="row body-box">
                                                  ...
                                                  <br>
                                                        ...
                                                        <div class="row">
                                                        <div class="col-xs-12 col-md-6 col-sm-6">
                                                        <label><strong>State/Province</strong></label> <br>
                                                            <input type="text" class="form-control">
                                                          </div>
                                                      ...
                                                      <label><strong>Country</strong></label><br>
                                                        ...
                                                        <hr>   
                                                        <div class="btn-pull-right"><button class="btn btn-info ">Add locations</button></div>
                                                        <div class="clear">&nbsp;</div>
