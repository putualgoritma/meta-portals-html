...
<div class="container">
                ...
                <section class="content-header col-md-12">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     ...
                     <li class="active">Claim Company Branche</li>
                        </ul>
                                            </div>
                    </div>
				...
				<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
					<label><strong>Branche(s)</strong></label>
					</div>
					<div class="col-xs-12 col-sm-10 col-md-10 col-lg-10">
					<input type="text" class="form-control" placeholder="[Branche]">
                    <br>
                    <button class="btn btn-info">Add branche </button> Or delete selected brache(s)
					</div>
                    </div>
                    
                    <hr>
                                    
             <div class="btn-pull-left"><a href="about-us.php" class="btn btn-info">Back to [previous page]</a></div>
            
            <div class="btn-pull-right"><a href="#" class="btn btn-info">Next step</a></div>
