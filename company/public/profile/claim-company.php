...
<div class="container">
                ...
                <section class="content-header col-md-12">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     ...
                     <li class="active">Claim Company</li>
                        </ul>
                                            </div>
                    </div>
                ...
                <p style="color:gray;">Please fill in atleast one number</p>
            ...
            <div class="btn-pull-right"><a href="claim-company-branche.php" class="btn btn-info">Next step</a></div>
