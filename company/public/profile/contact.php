...
<div class="container">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12">
                  <div class="box panel-body box-danger">
                    ...
                    <p><strong>Already have an account? <a href="">Sign in</a> to skip the personal details.</strong></p>
                    
                    <div class="row body-box box-danger">
            ...
            <br>
            <select class="select form-control" style="padding-left:28px;">
             ...
             <div class="btn-pull-right"><button class="btn btn-info">Submit</button></div>
