        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
      		<b>Websites</b>
			<ul class="list-style">
			<li><a href="">Title of website 1</a></li>
			<li><a href="">Title of website 2</a></li>
			<li><a href="">Title of website 3</a></li>
			</ul>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<b>Blogs</b>
			<ul class="list-style">
			<li><a href="">Title of blog 1</a></li>
			<li><a href="">Title of blog 2</a></li>
			<li><a href="">Title of blog 3</a></li>
			</ul>
      		</div>
			</div>
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li>
              ...
              <div class="fb-post" data-href="https://www.facebook.com/FacebookDevelopers/posts/10151471074398553" data-width="780"></div>
              <div class="clear">&nbsp;</div>
              <hr>
              <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
              <p><strong>Twitter</strong></p>
              <blockquote class="twitter-tweet" lang="en-gb"><p>Was never a penalty <a class="link" href="https://twitter.com/hashtag/BS?src=hash">#BS</a></p>&mdash; KSI (@KSIOlajidebt) <a class="link" href="https://twitter.com/KSIOlajidebt/status/548555530755903488">December 26, 2014</a></blockquote>
               ...
               <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                     <p><strong>Groups</strong></p>
                      <a class="link">Title of Linkdin group 1</a> <button class="btn btn-info btn-xs">Join</button>
                     <div>&nbsp;</div>
                      <a class="link">Title of Linkdin group 2</a> <button class="btn btn-xs btn-info">Join</button>
                     <div>&nbsp;</div>
                     <a class="link">Title of Linkdin group 3</a> <button class="btn btn-xs btn-info">Join</button>
                     </div>

              <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                 <p><strong>Fanpages</strong></p>
                 <a class="link">Title of Facebook fanpage 1</a> <button class="btn btn-xs btn-info">Like</button>
                 <div>&nbsp;</div>
                 <a class="link">Title of Facebook fanpage 2</a> <button class="btn btn-xs btn-info">Like</button>
                 <div>&nbsp;</div>
                 <a class="link">Title of Facebook fanpage 3</a> <button class="btn btn-xs btn-info">Like</button>
                 </div>
               </div>
