...
<div class="container">
          ...
          <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
            <img src="../../../img/img.jpg" alt="[Job photo]" class="img-responsive"/><br>
          </div>
      ...
      <br>
            ...
            nascetur ridicul <a href="#">Read more...</a></p>

     <div class="btn-pull-left"><a href="#">Professional([n])</a></div>            
     <div class="btn-pull-right"><button class="btn btn-info">Apply now</button>
     <button class="btn btn-info">View job</button></div>       
            ...
            <div class="box panel-body box-danger">
               ...
               <div class="row">
          <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
            <img src="../../../img/img2.jpg"  class="img-responsive" alt="[Job photo]" /><br>
          </div>
      ...
      <br>
            ...
            commodo ligula eget dolor. Aenean massa. Cum sociis 
            natoque penatibus et magnis dis parturient montes, 
            nascetur ridicul <a href="../../Jobs-Public/Profile/Description.php">Read more...</a></p>
     ...
     <button class="btn btn-info">View job</button></div>       
            ...
            <div class="box panel-body box-danger">
               ...
               <div class="row">
          <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
            <img src="../../../img/img3.jpg" class="img-responsive" alt="[Job photo]" /><br>
          </div>
