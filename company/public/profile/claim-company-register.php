...
<div class="container">
				...
				<section class="content-header col-md-12">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     ...
                     <li class="active">Claim Company Register</li>
                        </ul>
                                            </div>
                    </div>
                ...
                <div>&nbsp;</div>
                <input type="checkbox" > I have read and I agree to the <a href="../../empty.php">Terms and conditions</a>
                
                
              <div>&nbsp;</div>
            
            <div class="btn-pull-right"><button class="btn btn-info">Register</button></div>
