...
<?php include('../../../components/private/menus/left_menu_private.php'); ?>
            ...
            <?php include('../../../components/private/menus/top_menu_private.php'); ?>
                ...
                <h2 class="product-overview">Order details [date]</h2>
		...
		<div class="col-xs-12 col-sm-4 col-md-4">
			<img class="img-responsive" src="http://www.elektrodaily.com/wp-content/uploads/2014/05/question-mark.jpg" >
		</div>
			
			<div class="col-xs-12 col-sm-8 col-md-8">
            <div class="row">
				<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
					<h4 style="margin:0;"><a href="#">Product title</a></h4> 
				</div>
				<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
					<h4 style="margin:0;">Number of items ordered: [n]</h4>
				</div>
                </div>
				<p>Dit is een stuk tekst bestaande uit precies 160 tekens (incl. spaties en andere tekens) die dient als metabeschrijving en wordt getoond op een overzichtspagina.</p>

				</div>
			</div> 
                
                <div class="row body-box">
                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4" style="color:grey;">
				From: [currency] [price]/excl. VAT
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8" style="color:grey;">
				To: [currency] [price]/excl. VAT
                </div>
                </div>
                <div class="row body-box">
                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                        From: [price][currency]/incl. VAT
                    </div>
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                        To: [price][currency]/incl. VAT
                </div>
                <div>&nbsp;</div>
