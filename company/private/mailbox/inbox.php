...
<?php include('../../../components/private/menus/left_menu_private.php'); ?>
            ...
            <?php include('../../../components/private/menus/top_menu_private.php'); ?>
                ...
                <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="margin-bottom: 10px;"><a href="compose.php" class="btn btn-info btn-block">Compose e-mail</a></div>
                ...
                <table id="example2" class="table table-bordered table-hover table-striped table-mailbox">
					...
					<i class="fa fa-star-o"></i></td>
                                                <td><a href="#">[FirstName][Ln]</a></td>
                                                <td><a href="#">[SubjectOfMessage]</a></td>
                                                <td><a href="#">[dd-mm-yyyy hh:mm]</a></td>
                                                <td><a href="#">&nbsp;</a></td>
                                            </tr>
                                            <tr>
					...
					<i class="fa fa-star-o"></i></td>
                                    ...
                                    <div>&nbsp;</div>
                  <div class="btn-pull-right"><button class="btn btn-info"><i class="fa fa-trash-o"></i> Delete</button></div>
                </div>
