...
<?php include('../../../components/private/menus/left_menu_private.php'); ?>
            ...
            <?php include('../../../components/private/menus/top_menu_private.php'); ?>
				...
				<div class="col-xs-12 col-sm-offset-5 col-sm-3 col-md-offset-7 col-md-2" style="margin-top:7px;">
					Filter by:
				</div>
          ...
          <div class="col-xs-12 col-sm-2 col-md-1" style="width:10px; height:10px; margin-top:37px;">
              <input type="checkbox">
          </div>
          ...
          <div class="col-xs-12 col-sm-2 col-md-2">
            <img src="" style=" width:130px; 
                                ...
                                color:white;" alt="[Photo]" /><br>
          </div>
          

          <div class="col-xs-12 col-sm-7 col-md-7">
          <a>[First name] [Last name]</a><br>
          [Discipline]<br>
          <b>Professional Description:</b><br>

            Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean 
            commodo ligula eget dolor. Aenean massa. blala
            nascetur ridicul <a>Read more...</a>
          </div>
...
<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
    ...
    >>>>>>> origin/master
                ...
                <div class="btn-pull-left"><button class="btn btn-info">Delete</button></div>
