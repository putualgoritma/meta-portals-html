<?php include('../../../components/config.php'); ?><? $preview_link=$root_path."company/public/profile/rate-review.php"; ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
<?php include('../../../components/private/menus/left_menu_private.php'); ?>
  ...
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation"><a href="#myreviews" aria-controls="myreviews" role="tab" data-toggle="tab">Our reviews</a></li>
  </ul>
  ...
  <div class="tab-content">
   ...
   <div class="row">
    ...
    <div class="clear">&nbsp;</div>
    <div class="btn-pull-right"><button class="btn btn-info"><i class="fa fa-file-text"></i> Report</button>
...
<div class="btn-pull-right"><button class="btn btn-info">View replies</button>
...
<div class="btn-pull-right"><button class="btn btn-info">View replies</button><button class="btn btn-defaultprofdelete">Delete</button><button class="btn btn-info">Edit</button></div>
<div class="clear">&nbsp;</div>
<hr>
