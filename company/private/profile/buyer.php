<?php include('../../../components/config.php'); ?><? $preview_link=$root_path."company/public/profile/buyer.php"; ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
<?php include('../../../components/private/menus/left_menu_private.php'); ?>
 ...
 <div class="row body-box">
      ...
      <label><strong>Main email adress</strong></label>
      <br>
		 <input type="text" class="form-control" placeholder="">
<br>
        ...
        <div class="col-md-6 col-xs-12 col-sm-5 col-lg-6">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li>
              ...
              <input type="checkbox" id="inlineCheckbox1" value="option1"> Shipping adress is the same as the personal adress.
              <div>&nbsp;</div>
              <div class="row body-box">
                <div class="col-md-6 col-xs-12 col-sm-6 col-lg-6">
                <label><strong>First name</strong></label>
