...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<div>
			...
			<div>&nbsp;</div>
          <div>
		  <i class="fa fa-calendar"></i> July 02, 2015 <i class="fa fa-user padding-left"></i> by: Lorem ipsum dolor sit amet
          </div>
          <div>&nbsp;</div>
            ...
            <div><form action="post-name.php" method="post"><button class="btn btn-info">View blog</button></form></div>
